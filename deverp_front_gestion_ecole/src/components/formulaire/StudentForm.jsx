    ...
    <div className="flex flex-col flex-1">
      ...
      <form className="flex-1 flex flex-col">
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 flex-1">
          <Input label="Prénom" name="prenom" placeholder="Veillez saisir votre prénom" value={formState.student.prenom || ""} onChange={handleChange} validate={validateName} />
          <Input label="Nom" name="nom" placeholder="Veillez saisir votre nom" value={formState.student.nom || ""} onChange={handleChange} validate={validateName} />
          <Input label="Date Naissance" name="date" type="date" value={formState.student.date || ""} onChange={handleChange} validate={validateDate} />
          <Input label="Lieu Naissance" placeholder="Veillez saisir votre lieu de naissance" name="lieu" value={formState.student.lieu || ""} onChange={handleChange} validate={validateRequired} />
          <Input label="Adresse" placeholder="Veillez saisir votre adresse" name="adresse" value={formState.student.adresse || ""} onChange={handleChange} validate={validateRequired} />
          <Input label="Email" placeholder="Veillez saisir votre email" name="email" type="email" value={formState.student.email || ""} onChange={handleChange} validate={validateEmail} />
