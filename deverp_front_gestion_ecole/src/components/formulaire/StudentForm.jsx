    ...
    <div className="flex flex-col flex-1">
      ...
      <form className="flex-1 flex flex-col">
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 flex-1">
          <Input label="Prénom" placeholder="Veuillez saisir votre prénom" name="prenom" value={formState.student.prenom} onChange={handleChange} validate={validateName} />
          <Input label="Nom" name="nom" placeholder="Veuillez saisir votre nom" value={formState.student.nom} onChange={handleChange} validate={validateName} />
          <Input label="Date Naissance" name="date" type="date" value={formState.student.date} onChange={handleChange} validate={validateDate} />
          <Input label="Lieu Naissance" placeholder="Veuillez saisir votre lieu de naissance" name="lieu" value={formState.student.lieu} onChange={handleChange} validate={validateRequired} />
          <Input label="Adresse" placeholder="Veuillez saisir votre adresse" name="adresse" value={formState.student.adresse} onChange={handleChange} validate={validateRequired} />
          <Input label="Email" placeholder="Veuillez saisir votre email" name="email" type="email" value={formState.student.email} onChange={handleChange} validate={validateEmail} />
          <Input label="Téléphone" placeholder="Veuillez saisir votre numéro de téléphone" name="telephone" type="tel" value={formState.student.telephone} onChange={handleChange} validate={validatePhone} />
          <Input label="Nationalité" placeholder="Veuillez saisir votre nationalité" name="nationalite" value={formState.student.nationalite} onChange={handleChange} validate={validateNationality} />
